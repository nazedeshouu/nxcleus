...
class E:
    ...
    INTAKE_TURN = "intake.turn"
    INTAKE_MODE_CLASSIFIED = "intake.mode_classified"
    INTAKE_CLARIFICATION_REQUESTED = "intake.clarification_requested"
    INTAKE_CLARIFICATION_ANSWERED = "intake.clarification_answered"
    BOUNDARY_SANITIZED = "boundary.sanitized"
    BOUNDARY_SWEEP = "boundary.sweep"
    # stage 1 — planning
    PLAN_STARTED = "plan.started"
    PLAN_DELTA = "plan.delta"
    PLAN_COMPLETED = "plan.completed"
    PLAN_REPLANNED = "plan.replanned"
    PLAN_SCOPE_VIOLATION = "plan.scope_violation"
    # stage 2 — certification
    CERTIFY_CHECK_STARTED = "certify.check_started"
    CERTIFY_CHECK_COMPLETED = "certify.check_completed"
    ...
    CERTIFY_CONSULT_REQUESTED = "certify.consult_requested"
    CERTIFY_CONSULT_REPAIRED = "certify.consult_repaired"
    CERTIFY_REHYDRATED = "certify.rehydrated"
    CERTIFY_SCENARIOS_EMITTED = "certify.scenarios_emitted"
    ...
    TASK_FILES_WRITTEN = "task.files_written"
    TASK_FIX_APPLIED = "task.fix_applied"
    ...
    CONDUCTOR_GOAL_DRIFT = "conductor.goal_drift"
    # stage 5 — consolidation
    CONSOLIDATE_STARTED = "consolidate.started"
    CONSOLIDATE_ASSEMBLED = "consolidate.assembled"
    ...
    QA_PROBE = "qa.probe"
    QA_PROBE_STARTED = "qa.probe_started"
    QA_PROBE_PASSED = "qa.probe_passed"
    QA_PROBE_TIMEOUT = "qa.probe_timeout"
    QA_PROBE_EXHAUSTED = "qa.probe_exhausted"
